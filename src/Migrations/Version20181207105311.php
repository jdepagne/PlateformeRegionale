 ...
 */
final class Version20181207105311 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, titre_page VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, description_page VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, etat_publication_page TINYINT(1) NOT NULL, date_insertion_page DATETIME NOT NULL, date_modification_page DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
