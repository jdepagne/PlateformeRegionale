 ...
 */
final class Version20190114161458 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE module_categorie DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE module_categorie ADD PRIMARY KEY (module_id, categorie_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE module_categorie DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE module_categorie ADD PRIMARY KEY (categorie_id, module_id)');
